...
namespace BleizEntertainment
{
    public class PlayerMovementStates : IState
    {
        ...
        {
            Vector3 playerHorizontalVelocity = stateMachine._Player.rigidBody.velocity;
        ...
        {
            return new Vector3(0f, stateMachine._Player.rigidBody.velocity.y, 0f);
        }
        ...
        {
            stateMachine._Player.rigidBody.velocity = Vector3.zero;
        }
        protected void ResetVerticalVelocity()
        {
            Vector3 playerHorizontalVelocity = GetPlayerHorizontalVelocity();
            stateMachine._Player.rigidBody.velocity =playerHorizontalVelocity;
        }
