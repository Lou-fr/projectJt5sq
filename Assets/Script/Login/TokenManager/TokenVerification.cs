...
namespace TokenVerfication
{
    public class TokenVerification : MonoBehaviour
    {
        ...
        public static (bool succes, string content) VerifToken()
        {
            ...
            if (uwr.result == UnityWebRequest.Result.Success) return (true, uwr.downloadHandler.text);
            return (false, "");
        }
    }
}
